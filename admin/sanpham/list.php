                    ...
                    echo '<tr>
                            ...
                            <td>
																...
																<span
																	...
																	<span class="cursor-pointer p-2 hover:text-red-500" onclick="confirm("Bạn có đồng ý xóa sản phẩm hay không?")">
																		<a href="'.$xoasp.'" onclick="confirm("Bạn có đồng ý xóa sản phẩm hay không?")">
																	...
																	</svg></a onclick="confirm("Bạn có đồng ý xóa sản phẩm hay không?")">
																	</span>
																</div>
															</td>
                        </tr>';
