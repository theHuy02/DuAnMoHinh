                                ...
                                <div class="card adaptable-card !border-b pb-6 py-4 rounded-br-none rounded-bl-none">
                                    <div class="card-body">
                                        ...
                                        <div class="form-item vertical">
                                            ...
                                            <div>
                                                <input class="input" type="text" name="tensp" autocomplete="off"
                                                    placeholder="Name Product" value="">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-item vertical">
                                                ...
                                                <div>
                                                    <span class="input-wrapper undefined">
                                                        ...
                                                        <input class="input pl-8" type="number" name="price">
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-item vertical">
                                            ...
                                            <div>
                                                <span class="input-wrapper undefined">
                                                    ...
                                                    <input class="input pl-8" type="number" min=1 name="soluong">
                                                </span>
                                            </div>
                                        </div>
                                    </div>
